...
with tab_summary:
    ...
    **Interprétation technique :**
    ...
    1.  **☀️ Indice UV :** Le principal catalyseur. Le rayonnement solaire transforme les gaz en ozone de basse altitude.
    2.  **🌪️ Direction et Vitesse du vent :** Le facteur de transport et de dispersion.
    3.  **🌡️ Température et Humidité :** Ils influent sur la stabilité de la masse d'air et le piégeage des particules au sol.
